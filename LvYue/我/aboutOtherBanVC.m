...
@interface aboutOtherBanVC ()<UITextViewDelegate>{
...
@implementation aboutOtherBanVC
...
- (void)save{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/updatePersonalInfo",REQUESTHEADER] andParameter:@{@"userId":userId,@"userOpinionHalf":_textView.text} success:^(id successResponse) {
