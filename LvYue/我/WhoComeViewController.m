...
- (void)getDataFromWeb{
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/visitorList",REQUESTHEADER] andParameter:@{@"user_id":[LYUserService sharedInstance].userID,@"page":@"1"} success:^(id successResponse) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        detail.friendId = [model.userId integerValue];
    }else if (indexPath.section == 1){
