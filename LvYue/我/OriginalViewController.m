...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == 0) {
        ...
        [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/setCover",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",_imageData[_index][@"id"]],@"user_id":[LYUserService sharedInstance].userID} success:^(id successResponse) {
