...
- (void)viewDidLoad {
    ...
    UIView *setView = [[UIView alloc] initWithFrame:CGRectMake(0, 15 + 64, SCREEN_WIDTH, 44)];
    ...
    UIView *noteView = [[UIView alloc] initWithFrame:CGRectMake(0, 15 + 64 + 59, SCREEN_WIDTH, 44)];
