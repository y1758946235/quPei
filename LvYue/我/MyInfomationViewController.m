...
@interface MyInfomationViewController ()<UITableViewDataSource,UITableViewDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UIAlertViewDelegate>
{
    int provinceIndex;
    int cityIndex;
    int zoneIndex;
...
@property (nonatomic,strong) NSArray *sbArray;//cell标题数组
@property (nonatomic,strong) NSMutableArray *detailArray;//cell数据数组
...
- (void)viewDidLoad {
    ...
    self.sbArray = @[@"姓名",@"性别",@"年龄",@"地区",@"学历",@"行业",@"星级",@"豆客账号",@"我的技能",@"联系方式"];
    
#else
    
    self.sbArray = @[@"姓名",@"性别",@"年龄",@"地区",@"学历",@"行业",@"星级",@"豆客账号",@"豆客会员",@"我的技能",@"联系方式"];
...
- (void)changeIntroduce:(NSNotification *)aNotification{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"signature":self.introduceString,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
...
//                if (self.type == 0) {
//                    [[[UIAlertView alloc] initWithTitle:@"" message:@"您还未认证导游，不能修改该项" delegate:self cancelButtonTitle:@"好的" otherButtonTitles: nil] show];
//                }
//                else{
//                    self.bgView = [[bgView alloc] initWithFrame:self.view.frame];
//                    [self.view addSubview:self.bgView];
//                    [self createChangeMoneyView];
//                }
            }
                break;
            case 3:
...
//    else if (![LYFactory isPhone:self.nameField.text]){
...
//    }
        ...
        [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"contact":self.nameField.text,@"is_show":self.is_show,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
            [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
            MLOG(@"结果:%@",successResponse);
            if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureLive:(UIButton *)btn{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"provide_stay":self.canLive,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)noShowCode{
    ...
    [MBProgressHUD showMessage:nil toView:self.view];
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"is_show":@"0",@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureShowCode{
    ...
    [MBProgressHUD showMessage:nil toView:self.view];
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"is_show":@"1",@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureChangeJob{
    if (self.nameField.text.length == 0) {
        ...
        [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"industry":self.nameField.text,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
            MLOG(@"结果:%@",successResponse);
            [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
            if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureChangeMoney{
    if (self.nameField.text.length == 0) {
        ...
        [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"service_price":self.nameField.text,@"age":self.userAge} success:^(id successResponse) {
            MLOG(@"结果:%@",successResponse);
            [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
            if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)finishPicker:(UIButton *)btn{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"province":provinceName,@"city":cityName,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureChangeServiceAction{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"service_content":self.signString,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureChangeAge{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"age":self.nameField.text,@"service_price":self.serviceMoneyString} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
            [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
            [self backChangeName];
...
- (void)sureChangeSex:(UIButton *)btn{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"sex":self.userSex,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
        MLOG(@"结果:%@",successResponse);
        [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
        if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
...
- (void)sureChangeName{
    ...
    if (self.nameField.text.length == 0 || [self isBlankString:self.nameField.text] || ([self.nameField.text rangeOfString:@" "].location != NSNotFound)) {
        ...
        [MBProgressHUD showMessage:nil toView:self.view];
        [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/update",REQUESTHEADER] andParameter:@{@"id":[NSString stringWithFormat:@"%@",[LYUserService sharedInstance].userID],@"name":self.nameField.text,@"service_price":self.serviceMoneyString,@"age":self.userAge} success:^(id successResponse) {
            MLOG(@"结果:%@",successResponse);
            [MBProgressHUD hideAllHUDsForView:self.view animated:YES];
            if ([[NSString stringWithFormat:@"%@",successResponse[@"code"]] isEqualToString:@"200"]) {
