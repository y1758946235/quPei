...
@interface aboutSexVC ()<UITextViewDelegate>{
...
- (void)save{
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/user/updatePersonalInfo",REQUESTHEADER] andParameter:@{@"userId":userId,@"userOpinionSex":_textView.text} success:^(id successResponse) {
