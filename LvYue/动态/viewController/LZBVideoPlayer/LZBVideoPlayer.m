...
- (void)playVideoUrl:(NSURL *)url coverImageurl:(NSString *)coverUrl showInSuperView:(UIView *)superView
{
    ...
    if(coverUrl.length > 0)
    {
        ...
        //加载图片callBg.png  default_photo
        self.coverImageView.image = [UIImage imageNamed:@"callBg.png"];
    }
...
- (void)setCurrentPlayerLayer:(AVPlayerLayer *)currentPlayerLayer
{
    ...
    _currentPlayerLayer.videoGravity = AVLayerVideoGravityResizeAspectFill;//视频填充模式
}
