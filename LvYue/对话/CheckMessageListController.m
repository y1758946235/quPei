...
- (void)postRequest {
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/messageVerify/list",REQUESTHEADER] andParameter:@{@"pageNum":@"1",@"user_id":[LYUserService sharedInstance].userID,@"status":@"-1"} success:^(id successResponse) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    dest.friendId = [model.senderID integerValue];
...
- (void)passCheck:(UIButton *)sender {
    ...
    if ([model.type isEqualToString:@"1"]) {
        requestDict = @{@"user_id":[LYUserService sharedInstance].userID,@"friend_id":model.senderID,@"status":@"2"};
        ...
        requestDict = @{@"user_id":[LYUserService sharedInstance].userID,@"friend_id":model.senderID,@"group_id":model.groupID,@"status":@"2"};
        [MBProgressHUD showMessage:@"正在通过验证.."];
