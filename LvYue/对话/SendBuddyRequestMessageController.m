...
- (void)viewDidLoad {
    ...
    //提示信息
    UILabel *titleLabel        = [[UILabel alloc] initWithFrame:CGRectMake(25, 0, kMainScreenWidth - 20, 44)];
...
- (void)sendRequestMessage:(UIButton *)sender {
    ...
    [LYHttpPoster postHttpRequestByPost:[NSString stringWithFormat:@"%@/mobile/userFriend/addRequest", REQUESTHEADER] andParameter:@{ @"user_id": [LYUserService sharedInstance].userID,
                                                                                                                                      @"other_user_id": _buddyID,
                                                                                                                                      @"request_info": _messageView.text }
