...
- (instancetype)initWithStyle:(InputBarStyle)style {
    ...
    self = [super initWithFrame:CGRectMake(-0.5, ScreenHeight-height-64, ScreenWidth+1, height)];
...
- (void)keyboardWillShow:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:[info[UIKeyboardAnimationDurationUserInfoKey] doubleValue]
                     ...
                     animations:^{
                         ...
                         newInputViewFrame.origin.y = [UIScreen mainScreen].bounds.size.height-CGRectGetHeight(self.frame)-kbSize.height-64;
...
- (void)keyboardWillHidden:(NSNotification *)notification {
    ...
    [UIView animateWithDuration:[info[UIKeyboardAnimationDurationUserInfoKey] doubleValue]
                        ...
                        options:([info[UIKeyboardAnimationCurveUserInfoKey] integerValue]<<16)
                     animations:^{
                         self.center = CGPointMake(self.bounds.size.width/2.0f, height-64-CGRectGetHeight(self.frame)/2.0);
                     }
                     completion:nil];
}
