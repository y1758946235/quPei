...
@interface marryTableView ()<UITableViewDelegate,UITableViewDataSource>{
...
#pragma mark  -----下方约的数据
- (void)getAppointData{
//    [LYHttpPoster requestAppointContentDataWithTypeId:@"6" Block:^(NSArray *arr) {
