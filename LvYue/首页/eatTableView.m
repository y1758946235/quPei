...
@interface eatTableView ()<UITableViewDelegate,UITableViewDataSource>{
...
#pragma mark  -----下方约的数据
- (void)getAppointData{
//    [LYHttpPoster requestAppointContentDataWithTypeId:@"2" Block:^(NSArray *arr) {
